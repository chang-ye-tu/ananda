...
class gasinski1(book):
    
    def __init__(self):
        super(gasinski1, self).__init__()
        
        self.pgs = range(11, 1013)
        self.morph0 = 'c150.6'
        self.b_sep_sym_before = True 

        self.src = u"/home/clarktu/usr/doc/math/ex/Gasiński L, Papageorgiou N. Exercises in Analysis Part 1.pdf"
