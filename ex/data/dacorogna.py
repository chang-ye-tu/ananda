...
class dacorogna(book):
    
    def __init__(self):
        super(dacorogna, self).__init__()

        self.src = "/home/cytu/usr/doc/math/anly/th/Dacorogna B. Introduction to the Calculus of Variations 4ed.pdf"
        self.pgs = range(27, 356)
        self.tokens.update({
            'chapter': {'class': 'top',
                        'ocr': r'^Chapter (\d+)',
                        },
